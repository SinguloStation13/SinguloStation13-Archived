...
//Singulostation Edit start - adds an advanced variant to integrated welders
/obj/item/weldingtool/experimental/cyborg
	name = "advanced integrated welding tool"
	desc = "An advanced, experimental welder designed to be used in robotic systems. Custom framework doubles the speed of welding."
	icon = 'icons/obj/items_cyborg.dmi'
	icon_state = "indwelder_cyborg"
	toolspeed = 0.5
