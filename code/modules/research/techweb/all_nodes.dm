...
/datum/techweb_node/adv_engi
	...
	design_ids = list("engine_goggles", "magboots", "forcefield_projector", "weldingmask", "rcd_loaded", "rpd_loaded", "sheetifier", "ranged_analyzer") //--SinguloStation edit -- made the long-range analyzer researchable
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
	export_price = 5000
